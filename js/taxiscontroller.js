(function(){
    ...
    var app = angular.module('TaxiCentral', []).constant('API_URL', 'http://localhost:8080/TaxiCentral/');

    app.controller('taxiscontroller', ['$scope', '$http', 'API_URL', function($scope, $http, API_URL) {
